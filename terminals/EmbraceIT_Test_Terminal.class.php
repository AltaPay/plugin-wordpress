...
class WC_Gateway_EmbraceIT_Test_Terminal extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->id					= strtolower('altapay_EmbraceIT_Test_Terminal');
		$this->has_fields			= false;
		$this->method_title			= 'AltaPay - EmbraceIT Test Terminal';
		...
		$this->terminal				= 'EmbraceIT Test Terminal';
	...
	public function admin_options() {
		echo '<h3>EmbraceIT Test Terminal</h3>';
