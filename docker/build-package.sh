...
supported_versions_msg="This script supports only PHP versions 7.2 & 8.1 with docker"
...
if [ "$1" == "7.2" ]
  then
    docker build . --file docker/Dockerfile-build-image-php-7.2 -t plugin-wordpress-package-build
elif [ "$1" == "8.1" ]
  then
